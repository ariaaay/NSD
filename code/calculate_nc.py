...
def save_1d_noise_ceiling(
    ...
    shown_three = {1:10000, 2:10000, 3:6234, 4:5445, 5:10000, 6:6234, 7:10000, 8:5445} 
    # How many distinct images were shown at least twice to each subject?
    shown_two = {1:10000, 2:10000, 3:8355, 4:7846, 5:10000, 6:8355, 7:10000, 8:7846}
    # How many distinct images were shown at least once to each subject?
    shown_one = {1:10000, 2:10000, 3:9411, 4:9209, 5:10000, 6:9411, 7:10000, 8:9209}
    ...
    for subj in subjs:
        ...
        nc_file = nib.load(os.path.join(betas_subj_dir, "ncsnr.nii.gz")) # this is noise ceiling signal-to-noise ratio (ncsnr) for each voxel and NOT noise ceiling 
        ...
        noise_ceiling_1d = 100 * ((ncsnr_1d)**2 / ((ncsnr_1d)**2 + ((A/3+B/2+C/1)/(A+B+C))))
        ...
        # save it
        np.save("%s/noise_ceiling_1d_subj%02d.npy" % (subj_save_root, subj), noise_ceiling_1d)
